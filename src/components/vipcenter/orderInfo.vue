                                        ...
                                        <div class="center-nav">
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="list">
                                                        <p>
                                                             <router-link to="/orderlist" class="">
                                ...
                                <div class="right-auto">
                                    <div class="bg-wrap" style="min-height: 765px;">
                                        <div class="sub-tit">
                                            ...
                                            <ul>
                                                <li class="selected">
                                                    <router-link to="/vipcenter">查看订单</router-link>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="order-progress">
                                            <ul>
                                                ...
                                                <li :class="[{active : this.order.orderinfo.status>=3},'last']">
                                        ...
                                        <div class="form-box accept-box form-box1">
                                            <dl class="head form-group">
                                                <dd>
                                                    ...
                                                    <router-link :to="'/pay?orderid='+this.order.orderinfo.id" class="btn-pay">去付款</router-link>
                                                    <!---->
                                                </dd>
                                            </dl>
                                            <dl class="form-group">
        ...
        getOrderData() {
            ...
            this.$axios.get(url).then(response => {
                response.data.message.goodslist.forEach(goods => {
                    this.goods_price += goods.quantity * goods.real_price
                })
                this.goods_amount =this.goods_price +response.data.message.orderinfo.express_fee
                    this.express_fee = response.data.message.orderinfo.express_fee
